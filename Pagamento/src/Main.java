...
class PagamentoCartaoCredito implements PagamentoStrategy {
    ...
    public PagamentoCartaoCredito(String numeroCartao, String cpfCliente, String cvv, YearMonth dataValidade) {
...
public class Main {
    public static void main(String[] args) {
        ...
        PagamentoStrategy pagamentoCredito = new PagamentoCartaoCredito(numeroCartaoCredito, cpfCliente, cvv, dataValidade);
        ...
        PagamentoStrategy pagamentoDebito = new PagamentoCartaoDebito(numeroCartaoDebito);
